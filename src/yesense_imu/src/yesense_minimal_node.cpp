...
public:
  ...
  : rclcpp::Node(
    ...
    port_(get_parameter("yesense_port").as_string()),
    baudrate_(get_parameter("yesense_baudrate").as_int()),
    frame_id_(get_parameter("frame_id").as_string()),
    linear_acceleration_stddev_(get_parameter("linear_acceleration_stddev").as_double()),
    angular_velocity_stddev_(get_parameter("angular_velocity_stddev").as_double()),
    orientation_stddev_(get_parameter("orientation_stddev").as_double()),
    mode_(0),
    bytes_(0),
    index_(0),
    ck1_(0),
